...
class MakePDF():
    ...
    def grafico_janelas_moveis(self):
        ...
        self.pdf.image("./janela_movel_12M_retorno_movel.png", w = 80, h = 50, x = 15, y = 40)
        self.pdf.image("./janela_movel_12M_alfa.png", w = 80, h = 50, x = 110, y = 40)
        self.pdf.image("./janela_movel_24M_retorno_movel.png", w = 80, h = 50, x = 15, y = 90)
        self.pdf.image("./janela_movel_24M_alfa.png", w = 80, h = 50, x = 110, y = 90)
        self.pdf.image("./janela_movel_36M_retorno_movel.png", w = 80, h = 50, x = 15, y = 140)
        self.pdf.image("./janela_movel_36M_alfa.png", w = 80, h = 50, x = 110, y = 140)
        # self.pdf.add_page()
        self.pdf.image("./janela_movel_60M_retorno_movel.png", w = 80, h = 50, x = 15, y = 200)
        self.pdf.image("./janela_movel_60M_alfa.png", w = 80, h = 50, x = 110, y = 200)
